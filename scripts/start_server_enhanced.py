    ...
    <body>
        <script>
            ...
            function getHeaders() {
                ...
                if (apiKey && apiKey.value) headers['X-API-Key'] = apiKey.value;
                return headers;
            }
        ...
        <div class="container">
            ...
            <div class="tabs">
                <button class="tab active" onclick="switchTab('generate', this)">Generate</button>
                <button class="tab" onclick="switchTab('complete', this)">Complete Code</button>
